...
function grammar(text, num) {
    ...
    if (num == 0) {
        ...
        txt[19] = txt[18].replace(/&#9/g, ":]");
        txt[20] = txt[19].replace(/<ul style='list-style: circle !important'><li>/g, "[(");
